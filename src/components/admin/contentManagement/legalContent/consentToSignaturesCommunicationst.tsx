...
const ConsentToSignatureAndCommission = () => {
  ...
  const loadDocument = async () => {
    setLoading(true);
    try {
      const response = await getLegalContentByDocumentType('consent-to-signature-and-commission');
  ...
  const handleSubmit = async ( e: React.FormEvent<HTMLFormElement> ) => {
    ...
    try {
      await upsertLegalContent({
        documentType: 'consent-to-signature-and-commission',
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-100">
            <h3 className="text-lg font-semibold text-boldblue">
              Consent To Signatures & Commission
            </h3>
            <button
...
export default ConsentToSignatureAndCommission;