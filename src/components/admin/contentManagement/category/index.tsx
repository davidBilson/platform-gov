...
import ManageList from '@/components/admin/contentManagement/category/manageList';
import {
  getAllCategories,
  createCategory,
  getContentStats
} from '@/api/admin-api';
import AddCategoryModal from '@/components/admin/contentManagement/category/addCategoryModal';
...
const CategoryManagement = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-boldblue mb-2">Manage Categories</h2>
      </div>
