...
const LockedOverlay = ({ descriptionText, position} : { descriptionText: string; position?: string; }) => (
    
    <div className={`${position ? position : 'absolute'} inset-0 bg-white/50 backdrop-blur-sm z-50 flex items-center justify-center`}>
