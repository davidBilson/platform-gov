  ...
  const mockData: MockData = {
    available: [
      ...
      },
      {
        ...
        amount: 800,
        milestone: "Wireframe Creation",
        escrowDate: "2025-06-10",
        daysInEscrow: 6,
        status: "available"
      }
    ],
    inProgress: [
      ...
      },
      {
        ...
        amount: 1500,
        milestone: "Payment Gateway Setup",
        progress: 30,
    ...
    pendingReview: [
      ...
      },
      {
        ...
        freelancer: "James Brown",
        amount: 500,
        milestone: "Final Logo Concepts",
        submittedDate: "2025-06-15",
        reviewDeadline: "2025-06-18",
        daysToReview: 2,
        status: "pending-review"
      }
    ],
    released: [
      ...
      },
      {
        ...
        amount: 1950,
        milestone: "Initial Dashboard",
        releasedDate: "2025-06-05",
        releaseMethod: "PayPal",
        status: "released"
      }
    ],
    inDispute: [
      {
        ...
        freelancer: "Mark Thompson",
        amount: 1800,
        milestone: "CMS Development",
        disputeDate: "2025-06-10",
        disputeReason: "Incomplete functionality",
        daysSinceDispute: 6,
        status: "in-dispute"
      }
    ]
