      ...
      <section className='w-full max-w-2xl m-auto'>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-6">
          <input
            ...
            placeholder='Email'
            className='w-full max-w-75 m-auto 
            h-12.5 
            bg-white border border-boldblue rounded-lg py-4 pl-5 text-boldblue 
            text-sm font-medium focus:outline focus:outline-boldblue placeholder:font-medium'
            required
          />
