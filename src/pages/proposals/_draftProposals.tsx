...
// Define TypeScript interfaces based on MongoDB schema
...
interface Application {
  ...
  proposedRetainerFrequency?: 'Hour' | 'Day' | 'Week' | 'Month';
  ...
  status: 'draft' | 'pending' | 'viewed' | 'shortlisted' | 'interviewed' | 'accepted' | 'rejected' | 'withdrawn';
  clientNotes?: string;
  ...
  return (
    <section className='w-full max-w-275 m-auto border-b border-b-skyblue pb-10 mb-7.5'>
      ...
      {applications.length === 0 ? (
        <p className="text-gray-500 text-center py-5">No draft proposals</p>
      ) : (
