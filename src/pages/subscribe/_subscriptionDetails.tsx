...
const SubscriptionDetails = ({ subscriptionData }: { subscriptionData: any }) => {
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <button className="cursor-pointer bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition-colors">
            View Billing History
          </button>
          {isSubscriptionActive && (
            <button className="cursor-pointer bg-crimson text-white px-6 py-3 rounded-lg hover:bg-crimson/70 transition-colors">
              Cancel Subscription
            </button>
          )}
          {!isSubscriptionActive && (
            <button className="cursor-pointer bg-aquagreen text-white px-6 py-3 rounded-lg hover:bg-aquagreen/70 transition-colors">
