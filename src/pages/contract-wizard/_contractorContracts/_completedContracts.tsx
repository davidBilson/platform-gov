                ...
                <section className='flex flex-col md:flex-row items-start md:items-center justify-between gap-5'>
                  ...
                  <div className='font-bold text-sm'>
                    <Link
                      ...
                      href={{
                        pathname: `/contract-wizard/${contract.hiringId._id}`,
                        query: {
                    ...
                    <Link className='cursor-pointer hover:text-deepskyblue hover:underline' href={`/contract-wizard/${contract._id}`}>Submit For Payment</Link>
                  </div>
                </section>
              </div>
