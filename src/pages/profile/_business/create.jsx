...
const CreateBusinessProfile = () => {
  ...
  // Legal Agreement Helper Function
  let called = false;
  ...
  // Handle form submission with legal agreement check
  ...
  // Effect to handle pending submission after legal agreement
  useEffect(() => {
  ...
  // Main submit handler with legal agreement logic
  const handleSubmit = async () => {
    // If legal agreement already accepted, submit directly
